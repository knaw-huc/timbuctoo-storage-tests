...
public class Rdf4JLmdbSparqlTestCase extends TestCase {
    ...
    public Rdf4JLmdbSparqlTestCase(Test test) throws Exception {
        this.test = test;
        repository = new SailRepository(new LmdbStore(new File(
                "./data/rdf4j_lmdb_sparql/" + DigestUtils.md5Hex(test.getName()))));
